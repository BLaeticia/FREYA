...
const addLabResult = async (clinicId, { patientId, appointmentId, title, description, diagnosis }) => {
...
const updateProfile = async (userId, data) => {
  const { phone, bloodGroup, birthDate, gender, height, weight, allergies, chronicDiseases, currentMedications } = data;
  ...
  await prisma.patientProfile.upsert({
    ...
    update: {
      bloodType: bloodGroup !== undefined ? bloodGroup : undefined,
      ...
      chronicDiseases: chronicDiseases !== undefined ? chronicDiseases : undefined,
