...
const EMPTY_RESULT = { title: '', description: '', diagnosis: '' };
    ...
    <div className="font-sans bg-slate-50 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6 py-7">
        <div className="flex items-start justify-between mb-6">
          <div>
            <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Rendez-vous</h1>
            <p className="text-sm text-slate-500 mt-1">Gérez les demandes d'analyses de vos patients</p>
          </div>
          <button onClick={load} className="text-sm text-primary-600 border border-primary-200 bg-white rounded-xl px-4 py-2 font-semibold cursor-pointer hover:bg-primary-50 transition-colors">
            Actualiser
          </button>
        </div>
