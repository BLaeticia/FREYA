...
/* ─── Couleurs identiques à HomePage ──────────────
   Primary:  #0D9488  (teal)
   Dark:     #0F172A
   Gradient: linear-gradient(160deg, #065a50, #0D9488, #2DD4BF)
   Accent:   #FCD34D
────────────────────────────────────────────────── */
...
/* ── SIDEBAR (même style que HomePage CTA) ── */
.lp-sb { position:sticky; top:84px; display:flex; flex-direction:column; gap:14px; }

.lp-contact-card {
  background:linear-gradient(135deg, #065a50 0%, #0D9488 100%);
...
.lp-call-btn {
  width:100%; padding:13px; background:#fff; color:#0D9488;
  border:none; border-radius:10px; font-size:14px; font-weight:800;
  cursor:pointer; font-family:inherit; transition:all 0.15s; margin-top:14px;
...
export default function LabPublicPage() {
  ...
  if (!lab)    return (
    ...
    <div className="lp-404"><div className="lp-404-ic">🔬</div>
    ...
    <div className="lp-wrap">
      ...
      <div className="lp-body">
          ...
          <div className="lp-card">
            ...
            <div className="lp-card-body">
              <p style={{fontSize:13,color:'#64748B',marginBottom:18,lineHeight:1.6}}>
                Tarifs indicatifs en dinars algériens (DA). Une ordonnance médicale peut être requise pour certaines analyses. Contactez le laboratoire pour confirmation.
              </p>
        ...
        <div className="lp-sb">
          ...
          {/* Contact card avec gradient teal */}
