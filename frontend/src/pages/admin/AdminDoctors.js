...
export default function AdminDoctors() {
  ...
  useEffect(() => {
    adminAPI.getDoctors()
      .then(r => { setDoctors(r.data.doctors || r.data || []); setLoading(false); })
    ...
    <div className="font-sans bg-slate-50 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6 py-7">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Gestion des médecins</h1>
                  ...
                  {filtered.map(doc => {
                    ...
                    return (
                      <tr key={doc.id} className="hover:bg-primary-50/30 transition-colors">
                        ...
                        <td className="px-4 py-3.5 text-sm text-slate-600 border-b border-slate-100">{doc.specialty || '—'}</td>
