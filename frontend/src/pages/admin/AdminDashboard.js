...
export default function AdminDashboard() {
  ...
  const statItems = stats ? [
    { Icon: UserIcon,    iconColor: '#2563EB', bg: 'bg-primary-50',  val: stats.total_users,        label: 'Patients inscrits',     highlight: false },
    { Icon: DoctorIcon,  iconColor: '#059669', bg: 'bg-green-50',    val: stats.approved_doctors,   label: 'Médecins actifs',       highlight: false },
    { Icon: ClockIcon,   iconColor: '#F59E0B', bg: 'bg-amber-50',    val: stats.pending_doctors,    label: 'En attente validation', highlight: stats?.pending_doctors > 0 },
    { Icon: CalendarIcon,iconColor: '#2563EB', bg: 'bg-primary-50',  val: stats.total_appointments, label: 'RDV total',             highlight: false },
    { Icon: HospitalIcon,iconColor: '#7C3AED', bg: 'bg-violet-50',   val: stats.total_clinics,      label: 'Cliniques',             highlight: false },
    { Icon: BarChartIcon,iconColor: '#0284C7', bg: 'bg-sky-50',      val: stats.appointments_today, label: "RDV aujourd'hui",       highlight: false },
  ] : [];

  const quickActions = [
    { label: 'Valider les médecins', path: '/admin/doctors',      primary: true,  pending: stats?.pending_doctors },
